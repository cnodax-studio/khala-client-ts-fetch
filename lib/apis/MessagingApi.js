...
class MessagingApi extends runtime.BaseAPI {
    ...
    apiV1ChatsChatIdMessagesGetRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.ApiV1ChatsChatIdMessagesGet200ResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Get chat messages
     ...
     */
    apiV1ChatsChatIdMessagesMessageIdContentGetRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.chatId === null || requestParameters.chatId === undefined) {
     ...
     * Get message content in specific chat
     */
    apiV1ChatsChatIdMessagesMessageIdContentGet(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.apiV1ChatsChatIdMessagesMessageIdContentGetRaw(requestParameters, initOverrides);
        });
    }
    /**
     * Delete specific message
     */
    apiV1ChatsChatIdMessagesMessageIdDeleteRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.chatId === null || requestParameters.chatId === undefined) {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.ApiV1ChatsChatIdMessagesPost200ResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Delete specific message
     */
    apiV1ChatsChatIdMessagesMessageIdDelete(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiV1ChatsChatIdMessagesMessageIdDeleteRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    apiV1ChatsChatIdMessagesMessageIdGetRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.chatId === null || requestParameters.chatId === undefined) {
     ...
     * Get message in specific chat
     */
    apiV1ChatsChatIdMessagesMessageIdGet(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiV1ChatsChatIdMessagesMessageIdGetRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    apiV1ChatsChatIdMessagesMessageIdPatchRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.chatId === null || requestParameters.chatId === undefined) {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.ApiV1ChatsChatIdMessagesMessageIdPatchRequestToJSON)(requestParameters.payload),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.ApiV1ChatsChatIdMessagesPost200ResponseFromJSON)(jsonValue));
        });
    }
     ...
     * Update specific message
     */
    apiV1ChatsChatIdMessagesMessageIdPatch(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiV1ChatsChatIdMessagesMessageIdPatchRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
    ...
    apiV1ChatsChatIdMessagesPostRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.ApiV1ChatsChatIdMessagesPostRequestToJSON)(requestParameters.payload),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.ApiV1ChatsChatIdMessagesPost200ResponseFromJSON)(jsonValue));
        });
    }
