...
class ChatApi extends runtime.BaseAPI {
    ...
    apiV1ChatsChatIdGetRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ApiV1ChatsPost200ResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Get specific existing chat where user is member
    ...
    apiV1ChatsChatIdInvitePostRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.ApiV1ChatsChatIdInvitePostRequestToJSON)(requestParameters.payload),
            }, initOverrides);
    ...
    apiV1ChatsGetRaw(initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ApiV1ChatsGet200ResponseFromJSON)(jsonValue));
        });
    }
    /**
     * List existing chat where user is member
    ...
    apiV1ChatsPostRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.ApiV1ChatsPostRequestToJSON)(requestParameters.payload),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ApiV1ChatsPost200ResponseFromJSON)(jsonValue));
        });
    }
