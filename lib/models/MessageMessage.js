...
function MessageMessageFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'file': !(0, runtime_1.exists)(json, 'file') ? undefined : (0, FileMeta_1.FileMetaFromJSON)(json['file']),
        'id': !(0, runtime_1.exists)(json, 'id') ? undefined : json['id'],
        'isDeleted': !(0, runtime_1.exists)(json, 'is_deleted') ? undefined : json['is_deleted'],
        'isEdited': !(0, runtime_1.exists)(json, 'is_edited') ? undefined : json['is_edited'],
        'isSystem': !(0, runtime_1.exists)(json, 'is_system') ? undefined : json['is_system'],
        'mime': !(0, runtime_1.exists)(json, 'mime') ? undefined : json['mime'],
        'replyTo': !(0, runtime_1.exists)(json, 'reply_to') ? undefined : MessageMessageFromJSON(json['reply_to']),
...
function MessageMessageToJSON(value) {
    ...
    return {
        ...
        'date': value.date,
        'file': (0, FileMeta_1.FileMetaToJSON)(value.file),
        'id': value.id,
